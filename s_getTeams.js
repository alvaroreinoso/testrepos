...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getTeams', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getTeams, handlerWrapperArgs);
} catch (error) {
