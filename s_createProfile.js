...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-createProfile', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.createProfile, handlerWrapperArgs);
} catch (error) {
