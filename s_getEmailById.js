...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getEmailById', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getEmailById, handlerWrapperArgs);
} catch (error) {
