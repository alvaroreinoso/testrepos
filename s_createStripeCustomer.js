...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-createStripeCustomer', timeout: 20 };

try {
  const userHandler = require('././handlers/billing.js');
  module.exports.handler = serverlessSDK.handler(userHandler.createStripeCustomer, handlerWrapperArgs);
} catch (error) {
