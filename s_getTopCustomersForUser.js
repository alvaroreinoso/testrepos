...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getTopCustomersForUser', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getTopCustomersForUser, handlerWrapperArgs);
} catch (error) {
