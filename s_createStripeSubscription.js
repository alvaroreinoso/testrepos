...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-createStripeSubscription', timeout: 20 };

try {
  const userHandler = require('././handlers/billing.js');
  module.exports.handler = serverlessSDK.handler(userHandler.createStripeSubscription, handlerWrapperArgs);
} catch (error) {
