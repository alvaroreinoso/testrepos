...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-deleteUser', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.deleteUser, handlerWrapperArgs);
} catch (error) {
