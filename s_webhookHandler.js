...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-webhookHandler', timeout: 20 };

try {
  const userHandler = require('././handlers/billing.js');
  module.exports.handler = serverlessSDK.handler(userHandler.webhookHandler, handlerWrapperArgs);
} catch (error) {
