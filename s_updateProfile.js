...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-updateProfile', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.updateProfile, handlerWrapperArgs);
} catch (error) {
