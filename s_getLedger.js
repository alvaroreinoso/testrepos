...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getLedger', timeout: 6 };

try {
  const userHandler = require('././handlers/ledger.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getLedger, handlerWrapperArgs);
} catch (error) {
