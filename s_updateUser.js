...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-updateUser', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.updateUser, handlerWrapperArgs);
} catch (error) {
