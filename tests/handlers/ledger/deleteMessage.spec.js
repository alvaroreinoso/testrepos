...
describe('Test Delete message lambda', () => {
    ...
    test('Delete message fails with no auth', async () => {
    ...
    // test('Delete message succeeds for message belonging to current user', async () => {
    ...
    test('Returns 401 for message belonging to other user', async () => {
