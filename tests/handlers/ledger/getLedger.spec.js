...
describe('Test getLedger lambda', () => {

    test('get ledger fails without auth', async () => {
        ...
        const response = await ledgerHandler.getLedger(request)

        expect(response.statusCode).toBe(401)
        expect(response.body).toBe(undefined)
    })

    test('get ledger not in users brokerage', async () => {
    ...
    test('get ledger for user in users brokerage', async () => {
    ...
    test('get ledger for customer in users brokerage', async () => {
    ...
    test('get users own ledger', async () => {
