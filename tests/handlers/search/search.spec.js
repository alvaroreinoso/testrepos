...
describe('Test Search Lambda', () => {
    ...
    test('Search Users', async () => {
        ...
        const response = await searchHandler.searchUsersInBrokerage(request)
    ...
    test('Search Contacts', async () => {
        ...
        const response = await searchHandler.searchContacts(request)

        expect(response.statusCode).toStrictEqual(200)
    })

    test('Search Ledger', async () => {
        ...
        const response = await searchHandler.searchLedger(request)
