...
describe('Test updateLane lambda', () => {
  test('returns 204 when updating route geometry', async () => {
    const body = {
      frequency: 3,
      routeGeometry:
        'fakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;fljfakeGeometrysd;fksad;flj',
    }
