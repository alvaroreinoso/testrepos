...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getUser', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getUser, handlerWrapperArgs);
} catch (error) {
