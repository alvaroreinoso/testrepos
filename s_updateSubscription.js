...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-updateSubscription', timeout: 20 };

try {
  const userHandler = require('././handlers/billing.js');
  module.exports.handler = serverlessSDK.handler(userHandler.updateSubscription, handlerWrapperArgs);
} catch (error) {
