...
const handlerWrapperArgs = { functionName: 'terralanes-api-test-warmup-getTopLanesForUser', timeout: 6 };

try {
  const userHandler = require('././handlers/user.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getTopLanesForUser, handlerWrapperArgs);
} catch (error) {
